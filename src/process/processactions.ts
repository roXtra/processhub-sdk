...
export function createProcessInDbAction(processDetails: IProcessDetails, accessToken: string = null): <S>(dispatch: Dispatch<S>) => Promise<IGetProcessDetailsReply> {
  ...
  return async <S>(dispatch: Dispatch<S>): Promise<IGetProcessDetailsReply> => {
    dispatch<IProcessActionCreateInDb>({
...
export function deleteProcessFromDbAction(processId: string, accessToken: string = null): <S>(dispatch: Dispatch<S>) => Promise<Api.IBaseMessage> {
  return async <S>(dispatch: Dispatch<S>): Promise<Api.IBaseMessage> => {
    dispatch<IProcessActionDeleteFromDb>({
...
export function getAllServicesAction(): <S>(dispatch: Dispatch<S>) => Promise<IGetAllServicesReply> {
  return async <S>(dispatch: Dispatch<S>): Promise<IGetAllServicesReply> => {
...
export function loadProcessAction(processId: string, instanceId?: string, processExtras?: ProcessExtras, accessToken: string = null): <S>(dispatch: Dispatch<S>) => Promise<IGetProcessDetailsReply> {
  return async <S>(dispatch: Dispatch<S>): Promise<IGetProcessDetailsReply> => {
...
export function updateProcessAction(process: IProcessDetails, accessToken: string = null): <S>(dispatch: Dispatch<S>) => Promise<IGetProcessDetailsReply> {
  return async <S>(dispatch: Dispatch<S>): Promise<IGetProcessDetailsReply> => {
    dispatch({
...
export function copyProcessAction(processId: string, targetWorkspaceId: string, displayName: string, accessToken: string = null): <S>(dispatch: Dispatch<S>) => Promise<IGetProcessDetailsReply> {
  return async <S>(dispatch: Dispatch<S>): Promise<IGetProcessDetailsReply> => {
    dispatch({
      type: ProcessActionType.GetProcessDetails as ProcessActionType
    } as IProcessActionGetProcessDetails);
...
export function rateProcessAction(processId: string, ratingDiff: number, accessToken: string = null): <S>(dispatch: Dispatch<S>) => Promise<Api.IBaseReply> {
  return async <S>(dispatch: Dispatch<S>): Promise<Api.IBaseReply> => {
    const response: IGetProcessDetailsReply = await Api.postJson(
...
export function addRoXtraFileAction(processId: string, fileName: string, fileId: number, iconLink: string, accessToken: string = null): <S>(dispatch: Dispatch<S>) => Promise<IGetProcessDetailsReply> {
...
export function uploadFileAction(processId: string, fileName: string, data: string, accessToken: string = null): <S>(dispatch: Dispatch<S>) => Promise<IGetProcessDetailsReply> {
  return async <S>(dispatch: Dispatch<S>): Promise<IGetProcessDetailsReply> => {
    const response: IGetProcessDetailsReply = await Api.postJson(
...
export function uploadReportDraftAction(processId: string, fileName: string, data: string, accessToken: string = null): <S>(dispatch: Dispatch<S>) => Promise<IGetProcessDetailsReply> {
  return async <S>(dispatch: Dispatch<S>): Promise<IGetProcessDetailsReply> => {
    const response: IGetProcessDetailsReply = await Api.postJson(
...
export function deleteReportDraftAction(processId: string, draftId: string, accessToken: string = null): <S>(dispatch: Dispatch<S>) => Promise<IGetProcessDetailsReply> {
  return async <S>(dispatch: Dispatch<S>): Promise<IGetProcessDetailsReply> => {
    const response: IGetProcessDetailsReply = await Api.postJson(
...
export function deleteFileAction(processId: string, attachmentId: string, accessToken: string = null): <S>(dispatch: Dispatch<S>) => Promise<IGetProcessDetailsReply> {
  return async <S>(dispatch: Dispatch<S>): Promise<IGetProcessDetailsReply> => {
    const response: IGetProcessDetailsReply = await Api.postJson(
...
export function getTimersOfProcessAction(processId: string, accessToken: string = null): <S>(dispatch: Dispatch<S>) => Promise<IGetTimersOfProcessReply> {
...
export function setTimersOfProcessAction(processId: string, timers: ITimerStartEventConfiguration[], accessToken: string = null): <S>(dispatch: Dispatch<S>) => Promise<ISetTimersOfProcessReply> {
  return async <S>(dispatch: Dispatch<S>): Promise<ISetTimersOfProcessReply> => {
...
export function getProcessStatisticsAction(processId: string, fromDate: Date, tillDate: Date, accessToken: string = null): <S>(dispatch: Dispatch<S>) => Promise<IGetProcessStatisticsReply> {
  return async <S>(dispatch: Dispatch<S>): Promise<IGetProcessStatisticsReply> => {
