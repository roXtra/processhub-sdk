declare module "diagram-js/lib/layout/ManhattanLayout" {
   ...
   */
  export function connectRectangles(source: IBounds, target: IBounds, start: IPoint, end: IPoint, hints: {}): IPoint[];
   ...
   */
  export function layoutStraight(source: IBounds, target: IBounds, start: IPoint, end: IPoint, hints: {}): IPoint[];
